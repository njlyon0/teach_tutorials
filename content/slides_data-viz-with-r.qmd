...
```{r ext-data}
# Read in minnow data
fish_df <- read.csv(file = file.path("content", "data", "minnow.csv"))
```
...
![](images/visualization/hex-ggplot2.png){.absolute top=0 left=1100 width="12%" fig-alt="hex logo for ggplot2 R package"}
...
<p align="center">
<img src="images/visualization/graph-bad-labels.png" alt="Two scatterplots side by side with the same configuration of points but flipped axis labels." width="80%">
</p>
...
<p align="center">
<img src="images/visualization/custom-colors.png" alt="Meme where Pedro Pascal is saying 'life is good but it could be better' in two panels. Top panel is a default color graph then bottom panel is the same graph with custom colors" width="80%">
</p>
