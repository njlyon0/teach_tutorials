...
## {{< fa people-pulling >}} Class Coercion
...
## {{< fa file-circle-exclamation >}} Signaling Conditions
...
## {{< fa repeat >}} Looping Across Integers
...
## {{< fa hands-holding-circle >}} Selecting Elements
...
```{r}
#| label: select-double-brackets-v1
...
```{r}
#| label: select-double-brackets-v2
...
```{r}
#| label: select-double-bracket-vs-dollar-sign-v1
...
```{r}
#| label: select-double-bracket-vs-dollar-sign-v2
